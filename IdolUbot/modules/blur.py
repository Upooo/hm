__MODULE__ = "blur"
__HELP__ = """
<blockquote><b>--ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ʙʟᴜʀ--</b></blockquote>

<blockquote><b>🚦 ᴘᴇʀɪɴᴛᴀʜ :</b> <code>{0}blur [reply gambar]</code>
🦠 ᴋᴇᴛ : ᴜɴᴛᴜᴋ ᴍᴇɴɢᴜʙᴀʜ ɢᴀᴍʙᴀʀ ᴊᴀᴅɪ ʙʟᴜʀ.</b></blockquote>
"""
...
async def blur_cmd(client, message):
    ...
    xd = await message.reply(f"<blockquote><b>ᴛᴜɴɢɢᴜ ʙᴇɴᴛᴀʀ...</b></blockquote>")
    if not ureply:
